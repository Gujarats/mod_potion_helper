...
::PotionHelper.HooksMod <- ::Hooks.register(::PotionHelper.ID, ::PotionHelper.Version, ::PotionHelper.Name);::PotionHelper.HooksMod.require("mod_msu >= 1.9.0");::PotionHelper.HooksMod.queue(">mod_msu", function() {
	...
	if ("mods_getRegisteredMod" in getroottable() && ::mods_getRegisteredMod("mod_legends") != null) {
		::PotionHelper.Mod.Debug.printLog("[PotionHelper] Legends detected; Potion Helper hooks are disabled.");
		return;
	}
